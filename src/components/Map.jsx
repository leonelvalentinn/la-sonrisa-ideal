  ...
  return (
    <div className='px-4 mt-10 md:flex md:justify-center md:items-center md:w-full' id='location' ref={divRef}>
      ...
      <div className='container-map rounded-xl py-7 px-4 my-5 text-white text-center flex justify-center items-center flex-col bg-gradient-to-tr from-primaryBlue to-blue-600 md:shadow-gray-800 md:shadow-[-19px_3px_22px_-11px] md:h-[600px] md:max-w-[500px] md:p-8'>
        ...
        <p className=' mb-6 font-semibold'>Av Scop 826, Jardín, Fundadores, 78270 San Luis Potosí, S.L.P.</p>
        <h4 className='font-semibold text-xl'>Horario</h4>
        <p className='font-semibold'>Lunes a Viernes: 10am - 2pm y 4pm - 8:30pm</p>
        ...
        <div className='flex flex-col gap-4 items-center justify-center md:flex-row'>
          <a className='py-3 px-4 bg-white text-gray-800 font-semibold rounded-lg transition-all ease-in-out flex justify-center items-center hover:transition-all hover:scale-95' href='https://api.whatsapp.com/send?phone=524441340656' target='_blank' rel='noopener noreferrer'> <WhatsApp className='w-4 h-4 mr-2' /> Agenda tu cita</a>
          <a className='py-3 px-4 bg-red-500 text-white/90 font-semibold rounded-lg transition-all ease-in-out flex justify-center items-center hover:transition-all hover:scale-95' href='tel:4441340656' target='_blank' rel='noopener noreferrer'> <Phone className='w-4 h-4 mr-2' /> Urgencias 24/7</a>
        </div>
      </div>
    </div>
  )
